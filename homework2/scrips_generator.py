...
rep = 50
constructors = ['random', 'HEDGE']
localsearch = ['swap', 'circular']
    ...
    for constructor in constructors:
        for search in localsearch:
            for seed in range(1, rep + 1):
                output = ' /home/est_posgrado_alexcornejo/StoOpt/homework2/'
                output += instance + '/F' + str(c) + '_' + constructor + '_' + search + '/output' + str(
                    seed) + '.txt ' + str(constructor) + ' ' + search + ' false'
            ...
            for line in file:
                ...
                if line.startswith("Tasks"):
                    line = "Tasks=/home/est_posgrado_alexcornejo/StoOpt/homework2/" + slurm_target
